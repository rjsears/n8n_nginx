...
handle_version_detection() {
    ...
    case $current_version in
        "3.0")
            ...
            echo -e "${YELLOW}╔═══════════════════════════════════════════════════════════════════════════╗${NC}"
            echo -e "${YELLOW}║                                                                           ║${NC}"
            printf "${YELLOW}║${NC}%23s${BOLD}${YELLOW}EXISTING SETUP DETECTED${NC}%24s${YELLOW}║${NC}\n" "" ""
            echo -e "${YELLOW}║                                                                           ║${NC}"
            printf "${YELLOW}║${NC}%13s${WHITE}Version 3.0 installation found in this directory${NC}%13s${YELLOW}║${NC}\n" "" ""
            printf "${YELLOW}║${NC}%12s${GRAY}Your existing configuration and data are preserved${NC}%13s${YELLOW}║${NC}\n" "" ""
            echo -e "${YELLOW}║                                                                           ║${NC}"
            echo -e "${YELLOW}╚═══════════════════════════════════════════════════════════════════════════╝${NC}"
            echo ""
