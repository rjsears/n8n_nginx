...
EOF
    ...
    # Continue with port 443 server block
    cat >> "${SCRIPT_DIR}/nginx.conf" << EOF
    }
    ...
    server {
        ...
        # SSL Certificate paths (generated by setup.sh)
