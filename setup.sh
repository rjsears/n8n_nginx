...
handle_version_detection() {
    ...
    case $current_version in
        "3.0")
            ...
            echo -e "${YELLOW}╔═══════════════════════════════════════════════════════════════════════════╗${NC}"
            echo -e "${YELLOW}║                                                                           ║${NC}"
            echo -e "${YELLOW}║                  ${BOLD}${YELLOW}⚡  EXISTING SETUP DETECTED  ⚡${NC}                       ║${NC}"
            echo -e "${YELLOW}║                                                                           ║${NC}"
            echo -e "${YELLOW}║        ${WHITE}Version 3.0 installation found in this directory${NC}                 ║${NC}"
            echo -e "${YELLOW}║       ${GRAY}Your existing configuration and data are preserved${NC}                ║${NC}"
            echo -e "${YELLOW}║                                                                           ║${NC}"
            echo -e "${YELLOW}╚═══════════════════════════════════════════════════════════════════════════╝${NC}"
            echo ""
