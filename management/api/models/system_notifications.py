...
DEFAULT_SYSTEM_EVENTS = [
    ...
    # Backup verification events
    {
        ...
        "display_name": "Backup Verification Started",
        "description": "Notification when backup verification begins",
        "icon": "PlayIcon",
        "category": "backup",
        "severity": "info",
        "frequency": "every_time",
    ...
    },
    {
        ...
        "display_name": "Backup Verification Passed",
        "description": "Notification when backup verification completes successfully",
        "icon": "ShieldCheckIcon",
        "category": "backup",
        "severity": "info",
        "frequency": "every_time",
    ...
    },
    {
        ...
        "display_name": "Backup Verification Failed",
        "description": "Notification when backup verification fails",
        "icon": "ShieldExclamationIcon",
        "category": "backup",
        "severity": "critical",
        "frequency": "every_time",
    ...
    },
    {
        ...
        "description": "Notification when a container's CPU usage exceeds the threshold. Configure per-container thresholds in Container Config.",
        "icon": "CpuChipIcon",
        "category": "container",
        "severity": "warning",
        "frequency": "once_per_15m",
        "cooldown_minutes": 5,
        "flapping_enabled": True,
    },
    {
        ...
        "description": "Notification when a container's memory usage exceeds the threshold. Configure per-container thresholds in Container Config.",
        "icon": "CpuChipIcon",
        "category": "container",
        "severity": "warning",
        "frequency": "once_per_15m",
