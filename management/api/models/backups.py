...
class BackupSchedule(Base):
    ...
    timezone = Column(String(50), nullable=True, default=None)  # None = use system timezone from settings
...
class BackupContents(Base):
    ...
    # public_website_manifest: [{name, path, size, checksum, checksum_algorithm, modified_at}, ...]
