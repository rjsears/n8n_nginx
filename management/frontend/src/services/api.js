...
export const systemApi = {
  ...
  sslRenew: () => api.post('/system/ssl/renew', {}, { timeout: 300000 }), // 5 minute timeout for certbot renewal (DNS propagation can take 60-120s)
...
export const ntfyApi = {
  ...
  syncChannelsToTopics: () => api.post('/ntfy/topics/sync-from-channels'),
  // Saved Messages
