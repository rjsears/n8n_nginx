    ...
    <template v-else>
      ...
      <Card :neon="true" :padding="false">
        ...
        <Transition name="collapse">
          <div v-if="executionsExpanded" class="border-t border-gray-300 dark:border-slate-400">
            <EmptyState
            ...
            <div v-else class="overflow-x-auto">
              <table class="w-full">
                <thead>
                  <tr class="border-b border-gray-300 dark:border-slate-400 bg-gray-50 dark:bg-gray-800/50">
                ...
                <tbody>
                  <tr
                    ...
                    :key="execution.id"
                    class="border-b border-gray-300 dark:border-slate-400 last:border-0 hover:bg-gray-50 dark:hover:bg-gray-700/30"
                  >
                    <td class="py-3 px-4">
