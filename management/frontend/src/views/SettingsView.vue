        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card :neon="true" :padding="false">
            ...
            <div class="p-4">
              ...
              <div class="flex items-center justify-between mb-3 py-2 border-b border-gray-300 dark:border-slate-400">
              ...
              <div v-if="n8nApiKeyIsSet && !n8nApiKeyEditing" class="flex items-center justify-between mb-4 py-2 border-b border-gray-300 dark:border-slate-400">
          ...
          <Card :neon="true" :padding="false">
            ...
            <div class="p-4">
              ...
              <div class="flex items-center justify-between py-3 border-y border-gray-300 dark:border-slate-400">
                <div>
