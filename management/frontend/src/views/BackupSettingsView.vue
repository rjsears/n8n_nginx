<!--
-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
/management/frontend/src/views/BackupSettingsView.vue
        ...
        <div class="p-4 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700/50">
          <div class="flex gap-3">
            ...
            <div>
              ...
              <p v-if="isPublicWebsiteInstalled" class="text-sm text-amber-700 dark:text-amber-400">
                This backup system backs up <span class="font-semibold">N8N workflows</span>, <span class="font-semibold">N8N Management configuration files</span>, and <span class="font-semibold">Public Website files</span>.
