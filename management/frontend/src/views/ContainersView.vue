  ...
  <div class="space-y-6">
    ...
    <template v-else>
      ...
      <div v-else class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          <!-- Card Header -->
          <div class="p-4 border-b border-gray-300 dark:border-slate-500">
          ...
          <!-- Actions Footer -->
          <div class="p-4 border-t border-gray-300 dark:border-slate-500 flex items-center justify-between">
            <div class="flex items-center gap-2">
