...
async function runHealthCheck() {
  try {
    ...
    healthData.value.checks = response.data.checks || {}
          ...
          <Card :padding="false">
            <div class="p-4">
              ...
              <div class="space-y-2">
                ...
                <div class="flex justify-between items-center text-sm">
                  <span class="text-secondary">Recent (30d)</span>
                  <span class="font-medium text-primary">{{ healthData.checks?.backups?.details?.recent_count_30d || 0 }}</span>
                </div>
                <div class="flex justify-between items-center text-sm">
                  <span class="text-secondary">Failed (30d)</span>
                  <span :class="['font-medium', (healthData.checks?.backups?.details?.failed_count_30d || 0) > 0 ? 'text-red-500' : 'text-gray-500']">
                    {{ healthData.checks?.backups?.details?.failed_count_30d || 0 }}
                  </span>
                </div>
                    ...
                    >
                      <div class="flex items-center gap-2">
                        ...
                        <div class="min-w-0">
                          ...
                          <p class="text-xs text-muted font-mono truncate">{{ peer.tailscale_ips?.[0] || '' }}</p>
                        </div>
                      </div>
