#!/bin/bash
# Run this on your server to update the public website index.html with the WHITE template
# Usage: ./update_public_index.sh
# Note: Adjust volume name if needed (default: public_web_root)

VOLUME_NAME="${1:-public_web_root}"

docker run --rm -v "${VOLUME_NAME}:/data" alpine sh -c 'cat > /data/index.html << '"'"'HTMLEOF'"'"'
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .hero-graphic { margin-bottom: 2.5rem; position: relative; }
...
echo "Done! White template applied to index.html in ${VOLUME_NAME} volume"
